...
#
###############################################################################
def money(color,thickness):
    window = rg.TurtleWindow()
    cash = rg.SimpleTurtle()
    cash.pen.color = 'green'
    cash.pen.thickness = thickness
    mulah = rg.SimpleTurtle()
    mulah.pen.color = color
    mulah.pen.thickness = 5
    cash.forward(100)
    mulah.backward(100)
